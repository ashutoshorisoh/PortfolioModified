  ...
  return (
    <div ref={ref} className="bg-black min-h-screen px-4 py-8 flex flex-col">
      ...
      <div className='flex flex-col gap-10 justify-center items-center text-center p-10'>
        {/* Text Section */}
        <div className='lg:w-[50%] w-[90%] p-5 flex flex-col gap-6 justify-start items-start text-center text-white rounded-3xl bg-transparent'>
          <h1 className="text-white text-4xl font-bold">
            about<span className='text-red-400'>Me</span>
          </h1>
          <p className='lg:text-3xl text-xl text-left text-yellow-400'>
